...
namespace Discord.Modules
{
    ...
    public class ModuleManager
	{
		...
		private bool _useServerWhitelist, _useChannelWhitelist, _allowAll, _allowPrivate;
        ...
        public ModuleFilter FilterType{
            get { return _filterType; }
            set
            {
                _allowAll = value == ModuleFilter.None;
                _useServerWhitelist =   value.HasFlag(ModuleFilter.ServerWhitelist);
                _useChannelWhitelist =  value.HasFlag(ModuleFilter.ChannelWhitelist);
                _allowPrivate =         value.HasFlag(ModuleFilter.AlwaysAllowPrivate);
            }
        }
